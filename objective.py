...
def objective(trial):
    ...
    instruments = ['AUDNZD wyrownane ceny', 'AUDCHF wyrownane ceny', 'AUDNZD wyrownane swapy',
    'AUDCHF wyrownane swapy', 'NZDUSD', 'USDCHF'] 
    #DLA NZDUSD ZROBIĆ 1/KURS (boe nie ma USDNZD)
